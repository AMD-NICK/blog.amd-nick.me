...
- [**xShell** (лучшая альтернатива Putty)]( __GHOST_URL__ /xshell-alternative-for-putty). Главное преимущество это очень удобное управление сессиями и окнами на экране. На больших разрешениях даже банальная замена Putty на xShell дает значительный (хотя и далеко не самый большой прирост эффективности)
<figure class="kg-card kg-image-card"><img src="https://s3.blog.amd-nick.me/2020/03/xshell-screenshot.png" class="kg-image" alt loading="lazy"></img></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/image.png" class="kg-image" alt loading="lazy"><figcaption>SublimeText с темой Afterglow</figcaption></img></figure>
...
## GLua синтаксис
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/gmod-lua-syntax-sublimetext-plugin.png" class="kg-image" alt loading="lazy"><figcaption>Для установки этого плагина, нажмите в саблайме Ctrl+Shift+P, введите Install Package, затем выберите glua</figcaption></img></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/ignore_packages-lua-sublimetext-preferences.png" class="kg-image" alt loading="lazy"><figcaption>Мой файл настроек саблайма. Здесь настраивается тема, шрифт, а выделенным показано то, что вам нужно сделать, чтобы glua не конфликтовал с Lua</figcaption></img></figure>
## SFTP - избавляемся от FTP клиента
<figure class="kg-card kg-image-card"><img src="https://s3.blog.amd-nick.me/2020/03/sftp-sublimetext-plugin.png" class="kg-image" alt loading="lazy"></img></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/glua-linter-sublimetext-plugin.png" class="kg-image" alt loading="lazy"><figcaption>Красным выделена синтаксическая ошибка</figcaption></img></figure>
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/gmod-fprofiler.png" class="kg-image" alt loading="lazy"><figcaption>fprofiler - обнаружение тяжелых участков кода</figcaption></img></figure>
...
- **[IGS](https://gm-donate.ru)** - наш автодонат для Garry's Mod. Именно для наших клиентов я и начал писать эту статью. Мы [помогаем](https://vk.com/wall-143836547_1153) зарабатывать проектам больше, чем позволяет самопис или ручной прием платежей
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/gmod-igs-autodonate.jpg" class="kg-image" alt loading="lazy"><figcaption>IGS (InGameShop) - серверная часть автодоната для Garry's Mod проектов. На фото 2 версия интерфейса</figcaption></img></figure>
- **[gluegram](https://github.com/TRIGONIM/gluegram)** - мой фреймворк, позволяющий работать Telegram ботам прямо на Garry's Mod сервере. С их помощью я могу управлять сервером прямо через мессенджер. Если вам интересно, как я это делаю – напишите мне
...
<figure class="kg-card kg-image-card kg-card-hascaption"><img src="https://s3.blog.amd-nick.me/2020/03/gmod-epoe-console.png" class="kg-image" alt loading="lazy"><figcaption>epoe - внутриигровая серверная консоль</figcaption></img></figure>
* * *
