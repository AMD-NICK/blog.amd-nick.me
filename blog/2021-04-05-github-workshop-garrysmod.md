...
- Если у вас используются .dll, то придется искать им альтернативу. Для замены пушей через socket.dll мы сделали [long polling microservice](2021-03-08-webhook-bez-web-servera.md) и только выиграли от этого.
